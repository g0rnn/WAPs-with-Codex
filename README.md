...
🔍 프로젝트 탐색 & 아카이빙
- 프로젝트 설명, 썸네일, 참여 인원 등 한 학기의 프로젝트를 한 화면에서 파악
- 이전 학기 작품도 쉽게 찾아볼 수 있는 데이터 기반 아카이빙

🗳️ 프로젝트 투표
- 1인당 최대 3개의 프로젝트에 투표
- 실시간 투표 집계 및 학기별 인기 프로젝트 확인 가능

👥 팀 빌딩
- 학기별 팀 편성 과정 지원
- 필요한 기술 스택·팀 목표에 맞춰 원활한 팀 구성

📅 캘린더 기능
- 행사, 일정, 발표 등 WAP의 모든 중요한 이벤트를 자동 정렬
- 모바일에서도 보기 편한 일정 UI 제공
